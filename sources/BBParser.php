...
class HTML_BBCodeParser_Filter extends \bbparser
{
}
...
class HTML_BBCodeParser_Filter_Basic extends \HTML_BBCodeParser_Filter
{
    ...
    public $_definedTags = array(
        ...
        'blockquote' => array(
            ...
            'allowed'   => 'all',
            'attributes'=> array(
                "user" => 'user=%2$s%1$s%2$s',
                "cid" => 'cid=%2$s%1$s%2$s',
                "class" => 'class=%2$s%1$s%2$s'
            )
        ),
        'ol'  => array(
            'htmlopen'  => 'ol',
        ...
        'irony' => array(
            'htmlopen'  => 'span style="color:#CC3333; font-style:italic;"',
            'htmlclose' => 'span',
            'allowed'   => 'all',
            'attributes'=> array()
        ),
        'ny' => array(
            'htmlopen'  => 'span',//'span class="n-y"',
            'htmlclose' => 'span',
            'allowed'   => 'all',
            'attributes'=> array()
        ),
        'url' => array(
            ...
            'allowed'   => 'all',
            'attributes'=> array(
                'url' => 'href=%2$s%1$s%2$s target="blank" rel="nofollow"'
            )
        ),
        'user' => array(
            'htmlopen'  => 'a href="/users/%2$s%1$s%2$s/" target="blank" rel="nofollow"',
            'htmlclose' => 'a',
            'allowed'   => 'none',
            'attributes'=> array()
        ),
...
class BBParser
{
     ...
     * @return   mixed           tag in array format
     * @access   private
     * @see      _buildTagArray()
     * @author   Stijn de Reede  <sjr@gmx.co.uk>
     */
    public function _buildTag($str)
    {
        ...
        if (substr($str, 1, 1) == '/') {        // closing tag
            ...
            $tagArray = array();
            if (preg_match("!$oe([a-z0-9]+)[^$ce]*$ce!i", $str, $tagArray) == 0) { //@todo: preg_match
                return false;
            }
